...
from ._constant import FEAST_REPO
from ._constant import get_ws_feast_path, get_pj_name
from ._constant import get_ws_feast_parquet_dir, get_ws_feast_fv_dir
from ._constant import get_ws_feast_source_dir, get_ws_feast_entity_dir
...
async def make_feast_dirs(workspace_id: int):
    await __mkdir(get_ws_feast_path(workspace_id))
    mkdir_tasks = [
